...
if __name__ == "__main__":
    x_gpu = Variable(torch.arange(0, 4).resize_(1, 2, 2).double().cuda(), requires_grad=True)
    w_gpu = Variable(torch.arange(0, 12).resize_(1, 3, 2, 2).double().cuda(), requires_grad=True)
    print('x: ')
    print(x_gpu)
    print('w: ')
    print(w_gpu)
