...
from capsule_layer.functional import dynamic_routing, contract_routing, means_routing, cosine_routing, \
...
test_data = [(batch_size, out_capsules, in_capsules, out_length, routing_func, num_iterations) for batch_size
             ...
             routing_func in
             [dynamic_routing, contract_routing, means_routing, cosine_routing, tonimoto_routing, pearson_routing] for
