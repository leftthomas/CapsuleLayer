...
test_data = [(milestones, addition) for milestones in [[1, 2], [3, 5], [7, 12], [5, 8, 9], [4, 7, 10, 13]] for addition
             in [1, 2, 5]]


@pytest.mark.parametrize('milestones, addition', test_data)
def test_optim(milestones, addition):
